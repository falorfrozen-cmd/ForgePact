...
<div class="card tab-card" data-tab="mods" id="gameplayCard">
  ...
  <div class="row" style="border:none">
    ...
    <div class="row" style="border:none">
        <span class="lbl" style="width:auto;flex:1">Timed skill countdown<br><span style="font-size:11px;color:#8f816e;font-weight:normal">For Soul Spurn's and Maelstrom of Frost's plain casts, and Crematus where the game exposes that cast's own timer: draws how much of a timed cast is left over that skill's skill-bar slot, in the look you pick below. Lunar Orbit and Submerged Knives never show one - their plain cast creates no timed instance to read. A toggled-on skill never gets a countdown either way. Off by default; if a cast is already running when you turn this on, it shows as full until it is cast again.</span></span>
