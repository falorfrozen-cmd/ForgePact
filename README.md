...
| **Stop Double Cast Re-casting Soul Spurn** | A double cast proc can cast Soul Spurn a second time on its own, flipping the Purgatory toggle straight back; with this on, that extra cast is skipped and the toggle stays the way your press left it. Your own presses and other skills' double casts are untouched; the double cast's extra Soul Spurn is skipped without Purgatory too (off by default) |
